...
class DeactivatedEndorsementList extends StatefulWidget {
  ...
  @override
  State<DeactivatedEndorsementList> createState() =>
      _DeactivatedEndorsementListState();
}

class _DeactivatedEndorsementListState
    extends State<DeactivatedEndorsementList> {
  StreamSubscription<QuerySnapshot<Map<String, dynamic>>>? _streamSubscription;
  List<QueryDocumentSnapshot<Map<String, dynamic>>>
      _allDeactivatedEndorsements = [];
  List<QueryDocumentSnapshot<Map<String, dynamic>>> _cachedEndorsements =
    ...
    _streamSubscription = FirebaseFirestore.instance
      ...
      if (mounted) {
        setState(() {
          ...
          _cachedEndorsements = snapshot.docs; // Cache for immediate display
        });
      }
    });
  }
  ...
  List<QueryDocumentSnapshot<Map<String, dynamic>>> _filteredEndorsements(
      String query) {
    final filtered = _allDeactivatedEndorsements.where((doc) {
      final data = doc.data();
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                if (_cachedEndorsements.isNotEmpty) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return buildEndorsementListItem(
                          context, docs[index], data);
                    },
                  );
                }
